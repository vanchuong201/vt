$(window).load(function () {
	...
	if ($('div').is('.countdown')) {
        $('.countdown').jCounter({
            date: "01 SEPTEMBER 2017 12:00:00", // Deadline date
...
$(document).ready(function () {
    ...
    if ($('.video-bg')[0]) {
        $(function () {
            ...
            if (navigator.userAgent.match(/iPhone|iPad|iPod|Android|BlackBerry|IEMobile/i)) {
                BV.show('/sites/default/files/users/2/pagebuilderv5/elements/images/video_gag.jpg');
            } else {
                if (!!window.opera || navigator.userAgent.indexOf(' OPR/') >= 0) {
                    BV.show('/sites/default/files/users/2/pagebuilderv5/elements/video/video_bg.ogv', {
                        doLoop: true,
                        ambient: true
                    });
                } else {
                    BV.show('/sites/default/files/users/2/pagebuilderv5/elements/video/video_bg.mp4', {
                        doLoop: true,
                        ambient: true,
                        altSource: '/sites/default/files/users/2/pagebuilderv5/elements/video/video_bg.ogv'
                    });
                }
    ...
    $('#subscribe_form_2').validate({
        ...
        messages: {
            name: "Tên của bạn?",
            email: {
                required: "Chúng tôi cần địa chỉ email để liên hệ lại với bạn.",
